...
class WeakConvergence(PacedScene):
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(r"x_n\rightharpoonup x\ \Leftrightarrow\ f(x_n)\to f(x)\ \forall f\in X^*").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(r"x_n\rightharpoonup x\ \Leftrightarrow\ f(x_n)\to f(x)\ \forall f\in X^*").scale(0.62)
        eq2.move_to(eq)
