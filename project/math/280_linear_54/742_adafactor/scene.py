...
class AdaFactor(PacedScene):
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(r"R_{i}\approx\mathbb{E}[G_{i:}^2],\ C_{j}\approx\mathbb{E}[G_{:j}^2]").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(r"R_{i}\approx\mathbb{E}[G_{i:}^2],\ C_{j}\approx\mathbb{E}[G_{:j}^2]").scale(0.62)
        eq2.move_to(eq)
