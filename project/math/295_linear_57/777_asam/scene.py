...
class ASAM(PacedScene):
    """#777 ASAM（約45秒）"""

    def construct(self):
        self.show_heading("ASAM")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("適応的な鋭さ最小化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("軸ごとにスケール", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("SAM の改良", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"epsilon"+"^*="+chr(92)+"rho"+chr(92)+"frac"+"{"+chr(92)+"nabla"+" L}{"+chr(92)+""+"|"+chr(92)+"nabla"+" L"+chr(92)+""+"|_p}").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"epsilon"+"^*="+chr(92)+"rho"+chr(92)+"frac"+"{"+chr(92)+"nabla"+" L}{"+chr(92)+""+"|"+chr(92)+"nabla"+" L"+chr(92)+""+"|_p}").scale(0.75)
