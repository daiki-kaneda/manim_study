...
class SpiekerCenter(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("中点三角形の内心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("辺の中点", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("S=X(10)").scale(0.75)
