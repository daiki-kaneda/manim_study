...
class BevanPoint(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("外心と内心の関係", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("傍心三角形", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("外接円の中心", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("Be=X(40)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("Be=X(40)").scale(0.75)
