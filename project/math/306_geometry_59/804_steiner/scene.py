...
class SteinerPoint(PacedScene):
    """#804 シュタイナー点（約45秒）"""

    def construct(self):
        self.show_heading("シュタイナー点")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("等角共役の中心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("シュタイナー楕円", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("S=X(99)").scale(0.72)
