...
class SM3(PacedScene):
    """#814 SM3（約45秒）"""

    def construct(self):
        self.show_heading("SM3")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("メモリ節約適応法", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("行・列の最大値", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("大規模埋め込み", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("r_i"+chr(92)+"leftarrow"+chr(92)+"max"+"("+chr(92)+"beta"+" r_i,|g|)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("r_i"+chr(92)+"leftarrow"+chr(92)+"max"+"("+chr(92)+"beta"+" r_i,|g|)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("r_i"+chr(92)+"leftarrow"+chr(92)+"max"+"("+chr(92)+"beta"+" r_i,|g|)").scale(0.72)
