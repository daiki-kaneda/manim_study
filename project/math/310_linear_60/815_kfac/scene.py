...
class KFAC(PacedScene):
    """#815 K-FAC（約45秒）"""

    def construct(self):
        self.show_heading("K-FAC")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("自然勾配の近似", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("層ごとクロネッカー", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("フィッシャー情報", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("F"+chr(92)+"approx"+" A"+chr(92)+"otimes"+" B").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("F"+chr(92)+"approx"+" A"+chr(92)+"otimes"+" B").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("F"+chr(92)+"approx"+" A"+chr(92)+"otimes"+" B").scale(0.72)
