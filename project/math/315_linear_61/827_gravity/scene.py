...
class Gravity(PacedScene):
    """#827 Gravity（約45秒）"""

    def construct(self):
        self.show_heading("Gravity")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("重力つき最適化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ポテンシャル項", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("連続力学系", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ddot"+" x=-"+chr(92)+"nabla"+" f-"+chr(92)+"gamma"+chr(92)+"dot"+" x").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ddot"+" x=-"+chr(92)+"nabla"+" f-"+chr(92)+"gamma"+chr(92)+"dot"+" x").scale(0.72)
