...
class Adagrad(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("累積勾配で適応", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("対角スケーリング", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("疎な更新向き", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g/"+chr(92)+"sqrt"+"{G+"+chr(92)+"epsilon"+"}").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g/"+chr(92)+"sqrt"+"{G+"+chr(92)+"epsilon"+"}").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g/"+chr(92)+"sqrt"+"{G+"+chr(92)+"epsilon"+"}").scale(0.72)
