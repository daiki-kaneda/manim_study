...
class Lars(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("層ごと適応率", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("信頼域つきAdam", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("大きなバッチ", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+chr(92)+"frac"+"{"+chr(92)+""+"|x"+chr(92)+""+"|}{"+chr(92)+""+"|u"+chr(92)+""+"|}u").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+chr(92)+"frac"+"{"+chr(92)+""+"|x"+chr(92)+""+"|}{"+chr(92)+""+"|u"+chr(92)+""+"|}u").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+chr(92)+"frac"+"{"+chr(92)+""+"|x"+chr(92)+""+"|}{"+chr(92)+""+"|u"+chr(92)+""+"|}u").scale(0.72)
