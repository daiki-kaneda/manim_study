...
class AdaSmooth(PacedScene):
    """#839 AdaSmooth（約45秒）"""

    def construct(self):
        self.show_heading("AdaSmooth")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("滑らかさで学習率", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("局所曲率を見る", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("適応減衰", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+"_t="+chr(92)+"eta"+"/(1+"+chr(92)+""+"|"+chr(92)+"Delta"+" g_t"+chr(92)+""+"|)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+"_t="+chr(92)+"eta"+"/(1+"+chr(92)+""+"|"+chr(92)+"Delta"+" g_t"+chr(92)+""+"|)").scale(0.72)
