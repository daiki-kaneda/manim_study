...
class NinePointCenter(PacedScene):
    """#840 九点円中心（約45秒）"""

    def construct(self):
        self.show_heading("九点円中心")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円の中心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("垂心と外心の中点", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("オイラー線上", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("N=X(5)").scale(0.72)
