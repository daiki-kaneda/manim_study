...
class QHAdam(PacedScene):
    """#850 QHAdam（約45秒）"""

    def construct(self):
        self.show_heading("QHAdam")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("準双曲Adam", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("運動量の凸結合", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("Lookahead系", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("m_t="+chr(92)+"nu"+"_1 g_t+(1-"+chr(92)+"nu"+"_1)"+chr(92)+"beta"+"_1 m_{t-1}").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("m_t="+chr(92)+"nu"+"_1 g_t+(1-"+chr(92)+"nu"+"_1)"+chr(92)+"beta"+"_1 m_{t-1}").scale(0.70)
