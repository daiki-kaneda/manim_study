...
class AdamP(PacedScene):
    """#851 AdamP（約45秒）"""

    def construct(self):
        self.show_heading("AdamP")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("射影つきAdam", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("半径方向を抑制", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("ノルムの安定", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("g^"+chr(92)+"perp"+"").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("g^"+chr(92)+"perp"+"=g-"+chr(92)+"mathrm"+"{proj}_x g").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("g^"+chr(92)+"perp"+"=g-"+chr(92)+"mathrm"+"{proj}_x g").scale(0.70)
