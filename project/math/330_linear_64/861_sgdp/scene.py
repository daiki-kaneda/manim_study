...
class SGDP(PacedScene):
    """#861 SGDP（約45秒）"""

    def construct(self):
        self.show_heading("SGDP")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("射影つきSGD", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("AdamPのSGD版", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("ノルム制御", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g^"+chr(92)+"perp").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g^"+chr(92)+"perp").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("x"+chr(92)+"leftarrow"+" x-"+chr(92)+"eta"+" g^"+chr(92)+"perp").scale(0.68)
