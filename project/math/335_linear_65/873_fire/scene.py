...
class Fire(PacedScene):
    """#873 Fire（約45秒）"""

    def construct(self):
        self.show_heading("Fire")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("適応学習率の古典", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("増減の規則", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("収束の加速", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+chr(92)+"leftarrow"+" r"+chr(92)+"eta"+chr(92)+""+" "+chr(92)+"mathrm"+"{or}"+chr(92)+""+" d"+chr(92)+"eta").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+chr(92)+"leftarrow"+" r"+chr(92)+"eta"+chr(92)+""+" "+chr(92)+"mathrm"+"{or}"+chr(92)+""+" d"+chr(92)+"eta").scale(0.68)
