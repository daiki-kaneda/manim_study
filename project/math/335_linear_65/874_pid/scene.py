...
class Pid(PacedScene):
    """#874 Pid（約45秒）"""

    def construct(self):
        self.show_heading("Pid")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("制御つき最適化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("P・I・D項", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("u=K_p e+K_i"+chr(92)+"int"+" e+K_d"+chr(92)+"dot"+" e").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("u=K_p e+K_i"+chr(92)+"int"+" e+K_d"+chr(92)+"dot"+" e").scale(0.68)
