...
class AdaMod(PacedScene):
    """#886 AdaMod（約45秒）"""

    def construct(self):
        self.show_heading("AdaMod")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("適応率の平滑化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("長期平均で抑制", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("Adam系の安定", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+"_t="+chr(92)+"min"+"("+chr(92)+"eta"+"_t^{Adam},"+chr(92)+"bar"+chr(92)+"eta"+"_t)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+"_t="+chr(92)+"min"+"("+chr(92)+"eta"+"_t^{Adam},"+chr(92)+"bar"+chr(92)+"eta"+"_t)").scale(0.68)
