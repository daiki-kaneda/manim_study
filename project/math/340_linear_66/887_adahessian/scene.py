...
class AdaHessian(PacedScene):
    """#887 AdaHessian（約45秒）"""

    def construct(self):
        self.show_heading("AdaHessian")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ヘッセ対角を推定", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ハッチンソン跡", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("二次情報", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("D"+chr(92)+"approx"+chr(92)+"mathrm"+"{diag}(H)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("D"+chr(92)+"approx"+chr(92)+"mathrm"+"{diag}(H)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("D"+chr(92)+"approx"+chr(92)+"mathrm"+"{diag}(H)").scale(0.68)
