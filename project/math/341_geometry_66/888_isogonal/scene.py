...
class IsogonalConjugate(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("角の等分共役", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("等角線の交点", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("内心で自己", font_size=24).move_to(self.note)
