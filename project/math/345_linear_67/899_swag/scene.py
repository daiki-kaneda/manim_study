...
class SWAG(PacedScene):
    """#899 SWAG（約45秒）"""

    def construct(self):
        self.show_heading("SWAG")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("SWAのガウス近似", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("平均と分散", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("不確実性", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"theta"+chr(92)+"sim"+chr(92)+"mathcal"+"{N}("+chr(92)+"bar"+chr(92)+"theta"+","+chr(92)+"Sigma"+")").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"theta"+chr(92)+"sim"+chr(92)+"mathcal"+"{N}("+chr(92)+"bar"+chr(92)+"theta"+","+chr(92)+"Sigma"+")").scale(0.68)
