...
class MadGradOpt(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("双対平均化適応法", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("s_t=s_{t-1}+g_t^2").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("s_t=s_{t-1}+g_t^2").scale(0.68)
