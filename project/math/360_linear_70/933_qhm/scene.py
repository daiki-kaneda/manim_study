...
class QHM(PacedScene):
    """#933 QHM（約45秒）"""

    def construct(self):
        self.show_heading("QHM")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("準双曲动量", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("凸結合の动量", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("SGDの安定化", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("v="+chr(92)+"nu"+" g+(1-"+chr(92)+"nu"+")"+chr(92)+"beta"+" v").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("v="+chr(92)+"nu"+" g+(1-"+chr(92)+"nu"+")"+chr(92)+"beta"+" v").scale(0.68)
