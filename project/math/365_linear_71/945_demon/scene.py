...
class DemonAdam(PacedScene):
    """#945 DemonAdam（約45秒）"""

    def construct(self):
        self.show_heading("DemonAdam")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("減衰つきAdam", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("スケジュール动量", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("収束補助", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"beta"+"_t="+chr(92)+"beta"+chr(92)+"frac"+"{1-t/T}{1-"+chr(92)+"beta"+"^t}").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"beta"+"_t="+chr(92)+"beta"+chr(92)+"frac"+"{1-t/T}{1-"+chr(92)+"beta"+"^t}").scale(0.68)
