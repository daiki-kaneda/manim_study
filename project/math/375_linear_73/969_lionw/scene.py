...
class LionW(PacedScene):
    """#969 LionW（約45秒）"""

    def construct(self):
        self.show_heading("LionW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Lion＋重み減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("符号动量", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("m"+chr(92)+"leftarrow"+chr(92)+"beta"+" m+(1-"+chr(92)+"beta"+")g").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("m"+chr(92)+"leftarrow"+chr(92)+"beta"+" m+(1-"+chr(92)+"beta"+")g").scale(0.68)
