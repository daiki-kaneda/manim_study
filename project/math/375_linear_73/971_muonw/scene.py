...
class MuonW(PacedScene):
    """#971 MuonW（約45秒）"""

    def construct(self):
        self.show_heading("MuonW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon＋減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("直交化更新", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("U"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{Orth}(G)").scale(0.68)
