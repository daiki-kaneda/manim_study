...
class SOAPClip(PacedScene):
    """#983 SOAPClip（約45秒）"""

    def construct(self):
        self.show_heading("SOAPClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきSOAP", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("クロネッカー前処理", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("P"+chr(92)+"approx"+" L"+chr(92)+"otimes"+" R").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("P"+chr(92)+"approx"+" L"+chr(92)+"otimes"+" R").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("P"+chr(92)+"approx"+" L"+chr(92)+"otimes"+" R").scale(0.68)
