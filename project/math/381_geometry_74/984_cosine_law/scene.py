...
class CosineLaw(PacedScene):
    """#984 余弦法則（約45秒）"""

    def construct(self):
        self.show_heading("余弦法則")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("辺と角の関係", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ピタゴラス一般化", font_size=24).move_to(self.note)
