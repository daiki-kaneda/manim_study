...
class EulerDistance(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("外心と垂心の距離", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("Rと距離", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("OH^2=9R^2-a^2-b^2-c^2").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("OH^2=9R^2-a^2-b^2-c^2").scale(0.68)
