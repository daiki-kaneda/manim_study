...
class ProdigyW(PacedScene):
    """#994 ProdigyW（約45秒）"""

    def construct(self):
        self.show_heading("ProdigyW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Prodigy＋減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("D適応推定", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("d_t"+chr(92)+"approx"+chr(92)+""+"|x_0-x^*"+chr(92)+""+"|").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("d_t"+chr(92)+"approx"+chr(92)+""+"|x_0-x^*"+chr(92)+""+"|").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("d_t"+chr(92)+"approx"+chr(92)+""+"|x_0-x^*"+chr(92)+""+"|").scale(0.68)
