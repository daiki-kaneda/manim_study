...
class AdaiW(PacedScene):
    """#1006 AdaiW（約45秒）"""

    def construct(self):
        self.show_heading("AdaiW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Adai＋重み減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("適応慣性", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"beta"+"_{1,t}="+chr(92)+"mathrm"+"{clip}("+chr(92)+"hat"+chr(92)+"beta"+")").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"beta"+"_{1,t}="+chr(92)+"mathrm"+"{clip}("+chr(92)+"hat"+chr(92)+"beta"+")").scale(0.68)
