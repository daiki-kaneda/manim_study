...
class RangerW(PacedScene):
    """#1029 RangerW（約45秒）"""

    def construct(self):
        self.show_heading("RangerW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Ranger＋減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("Lookahead系", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("x"+chr(92)+"leftarrow"+" x+"+chr(92)+"alpha"+"("+chr(92)+"phi"+"-x)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("x"+chr(92)+"leftarrow"+" x+"+chr(92)+"alpha"+"("+chr(92)+"phi"+"-x)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("x"+chr(92)+"leftarrow"+" x+"+chr(92)+"alpha"+"("+chr(92)+"phi"+"-x)").scale(0.68)
