...
class LionClip(PacedScene):
    """#1041 LionClip（約45秒）"""

    def construct(self):
        self.show_heading("LionClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきLion", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("符号动量制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("m"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"beta"+" m+(1-"+chr(92)+"beta"+")g)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("m"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"beta"+" m+(1-"+chr(92)+"beta"+")g)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("m"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"beta"+" m+(1-"+chr(92)+"beta"+")g)").scale(0.68)
