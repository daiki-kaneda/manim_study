...
class AdoptClip(PacedScene):
    """#1055 AdoptClip（約45秒）"""

    def construct(self):
        self.show_heading("AdoptClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきAdopt", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("順序更新＋制限", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("収束安定", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("g"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}(g)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("g"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}(g)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("g"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}(g)").scale(0.68)
