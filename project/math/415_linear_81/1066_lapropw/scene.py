...
class LaPropW(PacedScene):
    """#1066 LaPropW（約45秒）"""

    def construct(self):
        self.show_heading("LaPropW")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("LaProp＋減衰", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("層適応伝播", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+"_l"+chr(92)+"propto"+" 1/"+chr(92)+""+"|g_l"+chr(92)+""+"|").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+"_l"+chr(92)+"propto"+" 1/"+chr(92)+""+"|g_l"+chr(92)+""+"|").scale(0.68)
