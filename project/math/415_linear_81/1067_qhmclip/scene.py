...
class QHMClip(PacedScene):
    """#1067 QHMClip（約45秒）"""

    def construct(self):
        self.show_heading("QHMClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきQHM", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("準双曲动量制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex("v"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"nu"+" g+(1-"+chr(92)+"nu"+")"+chr(92)+"beta"+" v)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex("v"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"nu"+" g+(1-"+chr(92)+"nu"+")"+chr(92)+"beta"+" v)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("v"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}("+chr(92)+"nu"+" g+(1-"+chr(92)+"nu"+")"+chr(92)+"beta"+" v)").scale(0.68)
