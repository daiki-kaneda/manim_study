...
class OILine(PacedScene):
    """#1068 内心外心線（約45秒）"""

    def construct(self):
        self.show_heading("内心外心線")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("OとIを結ぶ線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("オイラー距離", font_size=24).move_to(self.note)
