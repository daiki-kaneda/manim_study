...
class EulerDistRatio(PacedScene):
    """#1080 オイラー距離比（約45秒）"""

    def construct(self):
        self.show_heading("オイラー距離比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("OHとRの関係比", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("形で決まる", font_size=24).move_to(self.note)
