...
class AdaNormClip(PacedScene):
    """#1101 AdaNormClip（約45秒）"""

    def construct(self):
        self.show_heading("AdaNormClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきAdaNorm", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ノルム適応制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"Delta"+" x=-"+chr(92)+"eta"+chr(92)+""+","+chr(92)+"mathrm"+"{clip}(g/"+chr(92)+""+"|g"+chr(92)+""+"|)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"Delta"+" x=-"+chr(92)+"eta"+chr(92)+""+","+chr(92)+"mathrm"+"{clip}(g/"+chr(92)+""+"|g"+chr(92)+""+"|)").scale(0.68)
