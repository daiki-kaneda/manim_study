...
class LaPropClip(PacedScene):
    """#1103 LaPropClip（約45秒）"""

    def construct(self):
        self.show_heading("LaPropClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("クリップつきLaProp", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("層学習率制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+"_l"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}(1/"+chr(92)+""+"|g_l"+chr(92)+""+"|)").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+"_l"+chr(92)+"leftarrow"+chr(92)+"mathrm"+"{clip}(1/"+chr(92)+""+"|g_l"+chr(92)+""+"|)").scale(0.68)
