...
class GODistance(PacedScene):
    """#1105 重心外心距離（約45秒）"""

    def construct(self):
        self.show_heading("重心外心距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("GとOの距離", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("OHの1/3", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("GO=OH/3").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("GO=OH/3").scale(0.68)
