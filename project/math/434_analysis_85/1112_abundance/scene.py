...
class Abundance(PacedScene):
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('K_X'+chr(92)+" "+chr(92)+"mathrm"+'{nef}'+chr(92)+"Rightarrow"+chr(92)+"mathrm"+'{semiample}').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('K_X'+chr(92)+" "+chr(92)+"mathrm"+'{nef}'+chr(92)+"Rightarrow"+chr(92)+"mathrm"+'{semiample}').scale(0.62)
        eq2.move_to(eq)
