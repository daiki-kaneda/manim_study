...
class ExOrthoDistance(PacedScene):
    """#1117 傍心垂心距離（約45秒）"""

    def construct(self):
        self.show_heading("傍心垂心距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と垂心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("距離公式", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('I_aH').scale(0.68)
