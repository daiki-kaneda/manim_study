...
class AdaGradClip(PacedScene):
    """#1127 AdaGradClip（約45秒）"""

    def construct(self):
        self.show_heading("AdaGradClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("累積勾配制限", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("学習率減衰", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+'/'+chr(92)+"sqrt"+'{G+'+chr(92)+"epsilon"+'}'+chr(92)+" "+chr(92)+"mathrm"+'{clip}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+'/'+chr(92)+"sqrt"+'{G+'+chr(92)+"epsilon"+'}'+chr(92)+" "+chr(92)+"mathrm"+'{clip}').scale(0.68)
