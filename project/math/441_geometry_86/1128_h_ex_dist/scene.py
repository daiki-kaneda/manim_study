...
class HExDistance(PacedScene):
    """#1128 垂心傍心距離（約45秒）"""

    def construct(self):
        self.show_heading("垂心傍心距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Hと傍心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('HI_a').scale(0.68)
