...
class IGRatio(PacedScene):
    """#1130 内心重心比（約45秒）"""

    def construct(self):
        self.show_heading("内心重心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("IGの比表現", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("辺長比", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('IG/R').scale(0.68)
