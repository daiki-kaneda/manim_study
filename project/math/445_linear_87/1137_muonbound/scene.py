...
class MuonBound(PacedScene):
    """#1137 MuonBound（約45秒）"""

    def construct(self):
        self.show_heading("MuonBound")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon境界版", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("直交更新制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{bound}('+chr(92)+"mathrm"+'{Muon}(G))').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{bound}('+chr(92)+"mathrm"+'{Muon}(G))').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{bound}('+chr(92)+"mathrm"+'{Muon}(G))').scale(0.68)
