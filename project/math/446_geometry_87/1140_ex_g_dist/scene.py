...
class ExGDistance(PacedScene):
    """#1140 傍心重心距離（約45秒）"""

    def construct(self):
        self.show_heading("傍心重心距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と重心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('I_aG').scale(0.68)
