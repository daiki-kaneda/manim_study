...
class HGDistance(PacedScene):
    """#1141 垂心重心距離（約45秒）"""

    def construct(self):
        self.show_heading("垂心重心距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("HG=2GO", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("比は一定", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('HG=2GO').scale(0.68)
