...
class AdaDeltaClip(PacedScene):
    """#1149 AdaDeltaClip（約45秒）"""

    def construct(self):
        self.show_heading("AdaDeltaClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("RMS比クリップ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("更新幅制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"Delta"+' x'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"mathrm"+'{RMS})').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"Delta"+' x'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"mathrm"+'{RMS})').scale(0.68)
