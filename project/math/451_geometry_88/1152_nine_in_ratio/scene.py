...
class NineInRatio(PacedScene):
    """#1152 九点内心比（約45秒）"""

    def construct(self):
        self.show_heading("九点内心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("NとIの比", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("内心距離", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('NI/R').scale(0.68)
