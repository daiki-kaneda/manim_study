...
class HNineRatio(PacedScene):
    """#1153 垂心九点比（約45秒）"""

    def construct(self):
        self.show_heading("垂心九点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("HとN", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("HN=3ON", font_size=24).move_to(self.note)
