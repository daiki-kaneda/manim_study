...
class ExNineDistance(PacedScene):
    """#1164 傍心九点距離（約45秒）"""

    def construct(self):
        self.show_heading("傍心九点距離")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心とN", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("距離関係", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('I_aN').scale(0.68)
