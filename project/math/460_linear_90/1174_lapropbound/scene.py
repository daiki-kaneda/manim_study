...
class LaPropBound(PacedScene):
    """#1174 LaPropBound（約45秒）"""

    def construct(self):
        self.show_heading("LaPropBound")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("LaProp境界", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("層適応制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('p'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(p)').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('p'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(p)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('p'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(p)').scale(0.68)
