...
class InExLine(PacedScene):
    """#1176 内心傍心線（約45秒）"""

    def construct(self):
        self.show_heading("内心傍心線")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Iと傍心", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("線分関係", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('II_a').scale(0.68)
