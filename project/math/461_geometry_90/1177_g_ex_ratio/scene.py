...
class GExRatio(PacedScene):
    """#1177 重心傍心比（約45秒）"""

    def construct(self):
        self.show_heading("重心傍心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Gと傍心比", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("面積重み", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('GI_a/R').scale(0.68)
