...
class NineExRatio(PacedScene):
    """#1178 九点傍心比（約45秒）"""

    def construct(self):
        self.show_heading("九点傍心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Nと傍心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("接点配置", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('NI_a/R').scale(0.68)
