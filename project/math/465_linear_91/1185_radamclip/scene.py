...
class RAdamClip(PacedScene):
    """#1185 RAdamClip（約45秒）"""

    def construct(self):
        self.show_heading("RAdamClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("整流Adam制限", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"eta"+'_{'+chr(92)+"mathrm"+'{RAdam}})').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"eta"+'_{'+chr(92)+"mathrm"+'{RAdam}})').scale(0.68)
