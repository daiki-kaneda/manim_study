...
class AdaMaxClip(PacedScene):
    """#1186 AdaMaxClip（約45秒）"""

    def construct(self):
        self.show_heading("AdaMaxClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("∞ノルム適応", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("更新制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(m/u)').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(m/u)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(m/u)').scale(0.68)
