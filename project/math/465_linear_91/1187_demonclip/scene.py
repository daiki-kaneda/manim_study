...
class DemonClip(PacedScene):
    """#1187 DemonClip（約45秒）"""

    def construct(self):
        self.show_heading("DemonClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("減衰係数制限", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"beta"+'_t'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"beta"+'_t)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"beta"+'_t'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"beta"+'_t)').scale(0.68)
