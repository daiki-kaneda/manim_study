...
class NineHRatio(PacedScene):
    """#1190 九点円垂心比（約45秒）"""

    def construct(self):
        self.show_heading("九点円垂心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("NとHの比", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("半径関係", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('NH/R').scale(0.68)
