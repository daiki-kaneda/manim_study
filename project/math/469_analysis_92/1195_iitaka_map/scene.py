...
class IitakaMapRevisit(PacedScene):
    """#1195 飯高写像再訪（約45秒）"""

    def construct(self):
        self.show_heading("飯高写像再訪")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("飯高写像", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("次元κ", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"phi"+'_{|mK|}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"phi"+'_{|mK|}').scale(0.68)
