...
class DiffGradSoft(PacedScene):
    """#1197 DiffGradSoft（約45秒）"""

    def construct(self):
        self.show_heading("DiffGradSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("差分勾配軟化", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("適応", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"xi"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"Delta"+' g)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"xi"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"Delta"+' g)').scale(0.68)
