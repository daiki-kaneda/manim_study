...
class YogiSoft(PacedScene):
    """#1198 YogiSoft（約45秒）"""

    def construct(self):
        self.show_heading("YogiSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Yogi軟閾値", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}(v)').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}(v)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}(v)').scale(0.68)
