...
class YHClip(PacedScene):
    """#1199 YHClip（約45秒）"""

    def construct(self):
        self.show_heading("YHClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("YH更新制限", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"Delta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"Delta"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"Delta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"Delta"+')').scale(0.68)
