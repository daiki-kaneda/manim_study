...
class OrthoTriRatio(PacedScene):
    """#1201 垂心三角形比（約45秒）"""

    def construct(self):
        self.show_heading("垂心三角形比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("相似比", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("S'/S").scale(0.68)
