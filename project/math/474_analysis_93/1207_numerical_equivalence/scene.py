...
class NumericalEquivalence(PacedScene):
    ...
    def draw(self):
        ...
        note = self.ja_text("数値的に同値", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("交差で判定", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("ネフ錐", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('D'+chr(92)+"equiv"+'_{'+chr(92)+"mathrm"+"{num}} D'").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('D'+chr(92)+"equiv"+'_{'+chr(92)+"mathrm"+"{num}} D'").scale(0.68)
