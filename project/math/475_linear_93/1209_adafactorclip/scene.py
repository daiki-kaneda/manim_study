...
class AdaFactorClip(PacedScene):
    """#1209 AdaFactorClip（約45秒）"""

    def construct(self):
        self.show_heading("AdaFactorClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("因子分解適応", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"eta"+')').scale(0.68)
