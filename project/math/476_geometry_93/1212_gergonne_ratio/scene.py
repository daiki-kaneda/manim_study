...
class GergonneRatio(PacedScene):
    """#1212 ジェルゴンヌ比（約45秒）"""

    def construct(self):
        self.show_heading("ジェルゴンヌ比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ジェルゴンヌ点", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("チェバ比", font_size=24).move_to(self.note)
