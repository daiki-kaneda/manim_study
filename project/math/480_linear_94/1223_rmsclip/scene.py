...
class RMSClip(PacedScene):
    """#1223 RMSClip（約45秒）"""

    def construct(self):
        self.show_heading("RMSClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("RMSProp制限", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+'/'+chr(92)+"sqrt"+'{v}'+chr(92)+" "+chr(92)+"mathrm"+'{clip}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"eta"+'/'+chr(92)+"sqrt"+'{v}'+chr(92)+" "+chr(92)+"mathrm"+'{clip}').scale(0.68)
