...
class SymmedianIRatio(PacedScene):
    """#1226 類似内心比（約45秒）"""

    def construct(self):
        self.show_heading("類似内心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中心と内心", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("角条件", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('KI/R').scale(0.68)
