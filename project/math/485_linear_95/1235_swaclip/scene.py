...
class SWAClip(PacedScene):
    """#1235 SWAClip（約45秒）"""

    def construct(self):
        self.show_heading("SWAClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("平均化制限", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("軌跡平均", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"bar"+' w'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"bar"+' w)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"bar"+' w'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"bar"+' w)').scale(0.68)
