...
class SymORatio(PacedScene):
    """#1236 類似外心比（約45秒）"""

    def construct(self):
        self.show_heading("類似外心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中心と外心", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("円周角", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('KO/R').scale(0.68)
