...
class SymHRatio(PacedScene):
    """#1237 類似垂心比（約45秒）"""

    def construct(self):
        self.show_heading("類似垂心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中心と垂心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("オイラー線外", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('KH/R').scale(0.68)
