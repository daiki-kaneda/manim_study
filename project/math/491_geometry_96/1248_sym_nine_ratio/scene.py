...
class SymNineRatio(PacedScene):
    """#1248 類似九点比（約45秒）"""

    def construct(self):
        self.show_heading("類似九点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中心とN", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("距離比", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('KN/R').scale(0.68)
