...
class SymExRatio(PacedScene):
    """#1249 類似傍心比（約45秒）"""

    def construct(self):
        self.show_heading("類似傍心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中心と傍心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('KI_a/R').scale(0.68)
