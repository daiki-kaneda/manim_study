...
class RoundUp(PacedScene):
    """#1255 丸めアップ（約45秒）"""

    def construct(self):
        self.show_heading("丸めアップ")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("切り上げ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("境界調整", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"lceil"+' D'+chr(92)+"rceil").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"lceil"+' D'+chr(92)+"rceil").scale(0.68)
