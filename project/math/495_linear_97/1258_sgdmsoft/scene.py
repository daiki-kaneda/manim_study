...
class SGDMSoft(PacedScene):
    """#1258 SGDMSoft（約45秒）"""

    def construct(self):
        self.show_heading("SGDMSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("モーメンタム軟化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("速度平滑", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"beta"+' v+g)').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"beta"+' v+g)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('v'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"beta"+' v+g)').scale(0.68)
