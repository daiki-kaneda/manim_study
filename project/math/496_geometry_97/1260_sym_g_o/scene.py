...
class SymGO(PacedScene):
    """#1260 類似重心外心（約45秒）"""

    def construct(self):
        self.show_heading("類似重心外心")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("K・G・O", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("配置関係", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('KG,KO').scale(0.68)
