...
class FirstIsogonicRatio(PacedScene):
    """#1262 第一等角比（約45秒）"""

    def construct(self):
        self.show_heading("第一等角比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("第一等角中心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('X_{15}').scale(0.68)
