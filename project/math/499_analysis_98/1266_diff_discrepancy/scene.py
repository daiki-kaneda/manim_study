...
class DifferentDiscrepancy(PacedScene):
    """#1266 異なる食い違い（約45秒）"""

    def construct(self):
        self.show_heading("異なる食い違い")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("食い違い差", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("特異点比較", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('a(E;X,D)').scale(0.68)
