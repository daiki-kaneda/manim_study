...
class MinDiscrepancy(PacedScene):
    """#1267 最小食い違い（約45秒）"""

    def construct(self):
        self.show_heading("最小食い違い")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("最小食い違い", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("端末閾値", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("mld").scale(0.68)
