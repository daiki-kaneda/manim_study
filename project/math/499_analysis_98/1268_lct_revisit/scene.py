...
class LCTRevisit(PacedScene):
    """#1268 対数端末閾値（約45秒）"""

    def construct(self):
        self.show_heading("対数端末閾値")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("LCT再訪", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("跳躍", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex("lct").scale(0.68)
