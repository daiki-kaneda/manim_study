...
class SWASoft(PacedScene):
    """#1271 SWASoft（約45秒）"""

    def construct(self):
        self.show_heading("SWASoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("平均化平滑", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"bar"+' w'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"bar"+' w)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"bar"+' w'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"bar"+' w)').scale(0.68)
