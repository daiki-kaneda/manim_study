...
class SecondIsogonicRatio(PacedScene):
    """#1272 第二等角比（約45秒）"""

    def construct(self):
        self.show_heading("第二等角比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("第二等角中心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("等角線", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('X_{16}').scale(0.68)
