...
class IsogonalConjRatio(PacedScene):
    """#1273 等角共役比（約45秒）"""

    def construct(self):
        self.show_heading("等角共役比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("等角共役", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("チェバ逆", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('P^'+chr(92)+"ast").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('P^'+chr(92)+"ast").scale(0.68)
