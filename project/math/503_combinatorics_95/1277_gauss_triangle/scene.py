...
class GaussTriangle(PacedScene):
    """#1277 ガウス三角形（約45秒）"""

    def construct(self):
        self.show_heading("ガウス三角形")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ガウス二項", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("q類似", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"binom"+'{n}{k}_q').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"binom"+'{n}{k}_q').scale(0.68)
