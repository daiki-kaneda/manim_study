...
class MuonBoundClip(PacedScene):
    """#1283 MuonBoundClip（約45秒）"""

    def construct(self):
        self.show_heading("MuonBoundClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon境界クリップ", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"mathrm"+'{bound}(U))').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"mathrm"+'{bound}(U))').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('U'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}('+chr(92)+"mathrm"+'{bound}(U))').scale(0.68)
