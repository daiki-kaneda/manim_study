...
class IsotomicSegRatio(PacedScene):
    """#1285 等長線分比（約45秒）"""

    def construct(self):
        self.show_heading("等長線分比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("等長線分", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex("t/t'").scale(0.68)
