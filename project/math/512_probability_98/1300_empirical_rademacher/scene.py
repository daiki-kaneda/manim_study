...
class EmpiricalRademacher(PacedScene):
    """#1300 経験ラデマッハー（約45秒）"""

    def construct(self):
        self.show_heading("経験ラデマッハー")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("標本上の複雑度", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"hat"+' R_n').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"hat"+' R_n').scale(0.68)
