...
class SymmedianRatio(PacedScene):
    """#1308 類似中線比（約45秒）"""

    def construct(self):
        self.show_heading("類似中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("類似中線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("辺長二乗", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('b^2:c^2').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('b^2:c^2').scale(0.68)
