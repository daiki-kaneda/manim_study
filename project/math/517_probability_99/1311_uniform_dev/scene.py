...
class UniformDeviation(PacedScene):
    """#1311 一様偏差（約45秒）"""

    def construct(self):
        self.show_heading("一様偏差")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("一様偏差", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"sup"+'|P_n-P|').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"sup"+'|P_n-P|').scale(0.68)
