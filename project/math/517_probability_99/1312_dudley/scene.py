...
class DudleyEntropy(PacedScene):
    """#1312 ダドリーエントロピー（約45秒）"""

    def construct(self):
        self.show_heading("ダドリーエントロピー")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("エントロピー積分", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"int"+chr(92)+"sqrt"+'{'+chr(92)+"log"+' N}'+chr(92)+","+'d'+chr(92)+"epsilon").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"int"+chr(92)+"sqrt"+'{'+chr(92)+"log"+' N}'+chr(92)+","+'d'+chr(92)+"epsilon").scale(0.68)
