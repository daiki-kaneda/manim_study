...
class MuonSoftBound(PacedScene):
    """#1319 MuonSoftBound（約45秒）"""

    def construct(self):
        self.show_heading("MuonSoftBound")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon軟境界", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("二重平滑", font_size=24).move_to(self.note)
