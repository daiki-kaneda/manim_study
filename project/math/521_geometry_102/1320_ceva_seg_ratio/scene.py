...
class CevaSegRatio(PacedScene):
    """#1320 チェバ線分比（約45秒）"""

    def construct(self):
        self.show_heading("チェバ線分比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("チェバ線分", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("共点比", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('BD/DC').scale(0.68)
