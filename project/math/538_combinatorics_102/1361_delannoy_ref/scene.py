...
class DelannoyRefine(PacedScene):
    """#1361 デラノイ細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("デラノイ細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
