...
class IMedianRatio(PacedScene):
    """#1382 内心中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心と中線", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("辺長", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('IM/m_a').scale(0.68)
