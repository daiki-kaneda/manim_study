...
class OMedianRatio(PacedScene):
    """#1392 外心中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心と中線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("垂直二等分", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('OM/m_a').scale(0.68)
