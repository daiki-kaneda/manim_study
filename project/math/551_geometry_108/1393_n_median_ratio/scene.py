...
class NMedianRatio(PacedScene):
    """#1393 九点中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円と中線", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('NM/m_a').scale(0.68)
