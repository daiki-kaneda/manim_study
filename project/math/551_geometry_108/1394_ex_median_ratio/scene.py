...
class ExMedianRatio(PacedScene):
    """#1394 傍心中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と中線", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('I_aM/m_a').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('I_aM/m_a').scale(0.68)
