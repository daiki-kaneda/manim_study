...
class AdamaxSoft(PacedScene):
    """#1402 AdamaxSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("AdamaxSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("∞ノルム軟化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("更新平滑", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"max"+'('+chr(92)+"beta"+' u,|g|)').scale(0.62)
    ...
    def show_formula(self):
        formula = MathTex('x'+chr(92)+"leftarrow"+' x-'+chr(92)+"eta"+chr(92)+","+'m/'+chr(92)+"mathrm"+'{soft}(u)').scale(0.68)
