...
class BellTriangleRefine(PacedScene):
    """#1409 ベル三角形細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ベル三角形細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def show_formula(self):
        formula = MathTex('B(n,k)').scale(0.68)
