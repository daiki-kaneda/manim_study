...
class YHSoft(PacedScene):
    """#1415 YHSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("YHSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("YH軟化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ハイブリッド", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"Delta").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"Delta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"Delta"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('x'+chr(92)+"leftarrow"+' x-'+chr(92)+"eta"+chr(92)+","+chr(92)+"mathrm"+'{soft}('+chr(92)+"Delta"+')').scale(0.68)
