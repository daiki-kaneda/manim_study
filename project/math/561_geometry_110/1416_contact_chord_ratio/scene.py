...
class ContactChordRatio(PacedScene):
    """#1416 接点弦比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("接点弦比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("接点弦", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('x/y=(s-a)/(s-b)').scale(0.68)
