...
class MidpointChordRatio(PacedScene):
    """#1418 中点弦比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("中点弦比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("中点弦", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('M_bM_c/a').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('M_bM_c=a/2').scale(0.68)
