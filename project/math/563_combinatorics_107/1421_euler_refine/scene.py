...
class EulerRefine(PacedScene):
    """#1421 オイラー細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("オイラー細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("上昇細分", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('A(n,k)').scale(0.68)
