...
class AdaFactorSoft(PacedScene):
    """#1425 AdaFactorSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("AdaFactorSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("因子分解軟化", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"eta").scale(0.62)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"Delta"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"eta"+')g').scale(0.68)
