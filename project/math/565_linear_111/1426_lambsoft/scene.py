...
class LAMBSoft(PacedScene):
    """#1426 LAMBSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("LAMBSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("層適応軟化", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('r='+chr(92)+"|"+'w'+chr(92)+"|"+'/'+chr(92)+"|"+chr(92)+"Delta"+chr(92)+"|").scale(0.62)
    ...
    def show_formula(self):
        formula = MathTex('w'+chr(92)+"leftarrow"+' w-'+chr(92)+"eta"+chr(92)+","+chr(92)+"mathrm"+'{soft}(r)'+chr(92)+"Delta").scale(0.68)
