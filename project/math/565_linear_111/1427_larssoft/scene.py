...
class LARSSoft(PacedScene):
    """#1427 LARSSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("LARSSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("局所学習率軟化", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ノルム比", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"eta"+'_'+chr(92)+"ell").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"eta"+'_'+chr(92)+"ell"+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}('+chr(92)+"eta"+'_'+chr(92)+"ell"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('w'+chr(92)+"leftarrow"+' w-'+chr(92)+"mathrm"+'{soft}('+chr(92)+"eta"+'_'+chr(92)+"ell"+')g').scale(0.68)
