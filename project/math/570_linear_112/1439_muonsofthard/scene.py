...
class MuonSoftHard(PacedScene):
    """#1439 MuonSoftHard（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("MuonSoftHard")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon軟硬", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("二段閾値", font_size=24).move_to(self.note)
