...
class ExBisectorRatio(PacedScene):
    """#1441 傍心角二等分比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心角二等分比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と二等分", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('BD/DC=c/b').scale(0.68)
