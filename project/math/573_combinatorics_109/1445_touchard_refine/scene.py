...
class TouchardRefine(PacedScene):
    """#1445 タッチャード細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("タッチャード細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
