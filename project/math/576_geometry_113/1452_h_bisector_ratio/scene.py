...
class HBisectorRatio(PacedScene):
    """#1452 垂心角二等分比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心角二等分比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心と二等分", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ell"+'_H').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ell"+'_H/'+chr(92)+"ell").scale(0.68)
