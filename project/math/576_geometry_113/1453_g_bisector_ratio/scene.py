...
class GBisectorRatio(PacedScene):
    """#1453 重心角二等分比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("重心角二等分比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("重心と二等分", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ell"+'_G').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ell"+'_G/'+chr(92)+"ell").scale(0.68)
