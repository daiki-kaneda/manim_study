...
class NetApproximation(PacedScene):
    """#1456 ネット近似（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ネット近似")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ネット", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("一様近似", font_size=24).move_to(self.note)
        self.play(Transform(self.note, cap), run_time=0.9)
        self.read(0.25)
        cap2 = self.ja_text("誤差", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N_'+chr(92)+"epsilon").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"sup"+'|f-'+chr(92)+"hat"+' f|'+chr(92)+"le"+chr(92)+"epsilon").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"sup"+'|f-'+chr(92)+"hat"+' f|'+chr(92)+"le"+chr(92)+"epsilon").scale(0.68)
