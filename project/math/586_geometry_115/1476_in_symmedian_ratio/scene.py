...
class InSymmedianRatio(PacedScene):
    """#1476 内心類似中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心類似中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心と類似中線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("角条件", font_size=24).move_to(self.note)
