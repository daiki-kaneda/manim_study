...
class ExSymmedianRatio(PacedScene):
    """#1477 傍心類似中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心類似中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と類似中線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("外角", font_size=24).move_to(self.note)
