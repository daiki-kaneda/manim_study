...
class NSymmedianRatio(PacedScene):
    """#1490 九点類似中線比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点類似中線比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円と類似中線", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("中点", font_size=24).move_to(self.note)
