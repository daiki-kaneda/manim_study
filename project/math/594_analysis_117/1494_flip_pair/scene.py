...
class FlipPair(PacedScene):
    """#1494 フリップ対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("フリップ対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("フリップ対", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"phi"+'^+:X^+'+chr(92)+"to"+' Z').scale(0.62)
        eq2.move_to(eq)
