...
class ApolloSoft(PacedScene):
    """#1497 ApolloSoft（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ApolloSoft")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Apollo軟閾", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.3)
        cap2 = self.ja_text("軟閾", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{soft}(u)').scale(0.68)
