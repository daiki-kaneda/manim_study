...
class ApolloClip(PacedScene):
    """#1499 ApolloClip（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ApolloClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Apolloクリップ", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("制限", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(u)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('u'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{clip}(u)').scale(0.68)
