...
class ExExcircleRatio(PacedScene):
    """#1501 傍心傍接円比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心傍接円比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心と傍接円", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('r_a/r_b').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('r_a/r_b').scale(0.68)
