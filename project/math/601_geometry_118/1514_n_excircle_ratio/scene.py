...
class NExcircleRatio(PacedScene):
    """#1514 九点傍接円比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点傍接円比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円と傍接円", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('R_N/r_a').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('R_N/r_a').scale(0.68)
