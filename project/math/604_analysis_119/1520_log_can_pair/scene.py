...
class LogCanPair(PacedScene):
    """#1520 対数カノニカル対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("対数カノニカル対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("対数カノニカル", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("厳密", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('a(E,X,D)'+chr(92)+"ge"+' 0').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('a(E,X,D)'+chr(92)+"ge"+' 0').scale(0.68)
