...
class ExNagelRatio(PacedScene):
    """#1525 傍心ナーゲル比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心ナーゲル比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心とナーゲル", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('I_aNa/'+chr(92)+"ell").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('I_aNa/'+chr(92)+"ell").scale(0.68)
