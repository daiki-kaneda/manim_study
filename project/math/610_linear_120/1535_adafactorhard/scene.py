...
class AdaFactorHard(PacedScene):
    """#1535 AdaFactorHard（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("AdaFactorHard")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("AdaFactor硬閾", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('R,C'+chr(92)+"leftarrow"+chr(92)+"mathrm"+'{fact}(G^2)').scale(0.62)
