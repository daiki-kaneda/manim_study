...
class DualCovering(PacedScene):
    """#1575 双対被覆数（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("双対被覆数")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("双対被覆", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("パッキング双対", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N^*('+chr(92)+"epsilon"+')').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('N^*('+chr(92)+"epsilon"+')'+chr(92)+"asymp"+' M('+chr(92)+"epsilon"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('N^*('+chr(92)+"epsilon"+')'+chr(92)+"asymp"+' M('+chr(92)+"epsilon"+')').scale(0.68)
