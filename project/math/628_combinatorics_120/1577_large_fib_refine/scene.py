...
class LargeFibRefine(PacedScene):
    """#1577 大きなフィボナッチ細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("大きなフィボナッチ細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('F(n,k;m)').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('F(n,k;m)').scale(0.68)
