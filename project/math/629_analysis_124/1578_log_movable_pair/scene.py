...
class LogMovablePair(PacedScene):
    """#1578 ログ移動対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ移動対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ移動", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("ネフとの差", font_size=24).move_to(self.note)
