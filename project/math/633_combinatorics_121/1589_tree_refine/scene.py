...
class TreeRefine(PacedScene):
    """#1589 ツリー細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ツリー細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("木の数え上げ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ケイリー", font_size=24).move_to(self.note)
