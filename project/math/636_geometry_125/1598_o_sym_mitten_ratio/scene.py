...
class OSymMittenRatio(PacedScene):
    """#1598 外心類似ミッテン比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心類似ミッテン比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心と類似ミッテン", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('OM_s/'+chr(92)+"ell").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('OM_s/'+chr(92)+"ell").scale(0.68)
