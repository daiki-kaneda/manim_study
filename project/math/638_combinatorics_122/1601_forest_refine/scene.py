...
class ForestRefine(PacedScene):
    """#1601 森細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("森細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def show_formula(self):
        formula = MathTex('F(n,k)').scale(0.68)
