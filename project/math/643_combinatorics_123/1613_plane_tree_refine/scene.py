...
class PlaneTreeRefine(PacedScene):
    """#1613 平面木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("平面木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("平面木", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("順序つき", font_size=24).move_to(self.note)
