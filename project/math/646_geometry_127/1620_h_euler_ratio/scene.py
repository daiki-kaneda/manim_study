...
class HEulerRatio(PacedScene):
    """#1620 垂心オイラー比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心オイラー比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心とオイラー線", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('OH/R').scale(0.68)
