...
class NEulerRatio(PacedScene):
    """#1622 九点オイラー比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点オイラー比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円とオイラー線", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('ON=NH').scale(0.68)
