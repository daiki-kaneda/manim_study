...
class UniformPacking(PacedScene):
    """#1635 一様パッキング（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("一様パッキング")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("一様パッキング", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('M_u('+chr(92)+"epsilon"+')').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('M_u('+chr(92)+"epsilon"+')'+chr(92)+"le"+' M('+chr(92)+"epsilon"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('M_u('+chr(92)+"epsilon"+')'+chr(92)+"le"+' M('+chr(92)+"epsilon"+')').scale(0.68)
