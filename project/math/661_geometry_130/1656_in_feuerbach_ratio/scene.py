...
class InFeuerbachRatio(PacedScene):
    """#1656 内心フォイエルバッハ比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心フォイエルバッハ比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心とフォイエルバッハ", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('d(I,N)/r').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('d(I,N)/r').scale(0.68)
