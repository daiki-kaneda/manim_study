...
class OFeuerbachRatio(PacedScene):
    """#1658 外心フォイエルバッハ比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心フォイエルバッハ比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心とフォイエルバッハ", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('ON/R').scale(0.68)
