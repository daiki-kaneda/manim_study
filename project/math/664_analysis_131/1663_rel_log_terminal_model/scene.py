...
class RelLogTerminalModel(PacedScene):
    """#1663 相対ログ終端対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("相対ログ終端対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("相対ログ終端", font_size=24)
    ...
    def mid(self):
        ...
        self.read(0.25)
        cap2 = self.ja_text("相対ネフ", font_size=24).move_to(self.note)
