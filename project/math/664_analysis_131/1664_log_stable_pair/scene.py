...
class LogStablePair(PacedScene):
    """#1664 ログ安定対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ安定対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ安定", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("半安定", font_size=24).move_to(self.note)
