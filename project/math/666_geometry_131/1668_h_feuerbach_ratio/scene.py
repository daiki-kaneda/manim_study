...
class HFeuerbachRatio(PacedScene):
    """#1668 垂心フォイエルバッハ比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心フォイエルバッハ比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心とフォイエルバッハ", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('HN/R').scale(0.68)
