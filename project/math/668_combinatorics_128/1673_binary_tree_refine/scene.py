...
class BinaryTreeRefine(PacedScene):
    """#1673 二分木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("二分木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("二分木", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("左右", font_size=24).move_to(self.note)
