...
class InFeuerbachTouch(PacedScene):
    """#1680 内心フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心接点比", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('IT/r').scale(0.68)
