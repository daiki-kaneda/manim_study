...
class OFeuerbachTouch(PacedScene):
    """#1682 外心フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心接点比", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('OT/R').scale(0.68)
