...
class OrderedTreeRefine(PacedScene):
    """#1685 順序木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("順序木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("順序木", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('O(n,k)').scale(0.68)
