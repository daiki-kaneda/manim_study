...
class HFeuerbachTouch(PacedScene):
    """#1692 垂心フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心接点比", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('HT/R').scale(0.68)
