...
class GFeuerbachTouch(PacedScene):
    """#1693 重心フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("重心フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("重心接点比", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('GT/'+chr(92)+"ell").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('GT/'+chr(92)+"ell").scale(0.68)
