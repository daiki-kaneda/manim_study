...
class NFeuerbachTouch(PacedScene):
    """#1694 九点フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点円接点比", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('NT/R_N').scale(0.68)
