...
class LogNormalPair(PacedScene):
    """#1698 ログ正規対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ正規対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ正規", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("正規交叉", font_size=24).move_to(self.note)
