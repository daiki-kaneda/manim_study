...
class LogCushionPair(PacedScene):
    """#1700 ログクッション対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログクッション対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログクッション", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("食い違い余裕", font_size=24).move_to(self.note)
