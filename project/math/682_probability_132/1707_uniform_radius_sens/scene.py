...
class UniformRadiusSens(PacedScene):
    """#1707 一様半径敏感度（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("一様半径敏感度")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("一様半径敏感度", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"phi"+"_u'(r)").scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"phi"+"_u'(r)"+chr(92)+"propto"+' r^{'+chr(92)+"alpha"+'-1}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"phi"+"_u'(r)"+chr(92)+"propto"+' r^{'+chr(92)+"alpha"+'-1}').scale(0.68)
