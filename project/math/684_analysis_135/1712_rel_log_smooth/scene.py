...
class RelLogSmooth(PacedScene):
    """#1712 相対ログ平滑対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("相対ログ平滑対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("相対ログ平滑", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("相対スムース", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('X/S').scale(0.68)
