...
class LogSimplePair(PacedScene):
    """#1722 ログ単純対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ単純対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ単純", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("単純特異", font_size=24).move_to(self.note)
