...
class LogSncPair(PacedScene):
    """#1724 ログ純交対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ純交対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ純交", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("単純正規交叉", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('D_i'+chr(92)+"pitchfork"+' D_j').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('D_i'+chr(92)+"pitchfork"+' D_j').scale(0.68)
