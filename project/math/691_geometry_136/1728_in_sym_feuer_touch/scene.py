...
class InSymFeuerTouch(PacedScene):
    """#1728 内心類似フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心類似フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心類似接点", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('IT_s/r').scale(0.68)
