...
class LogCodimPair(PacedScene):
    """#1735 ログ余次元対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ余次元対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ余次元", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("特異余次元", font_size=24).move_to(self.note)
