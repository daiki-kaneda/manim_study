...
class HSymFeuerTouch(PacedScene):
    """#1740 垂心類似フォイエル接点比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心類似フォイエル接点比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心類似接点", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('HT_s/R').scale(0.68)
