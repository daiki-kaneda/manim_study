...
class DataCovering(PacedScene):
    """#1744 データ依存被覆（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("データ依存被覆")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("データ依存被覆", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("標本被覆", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N_n('+chr(92)+"epsilon"+')').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('N_n('+chr(92)+"epsilon"+')'+chr(92)+"le"+' N('+chr(92)+"epsilon"+')').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('N_n('+chr(92)+"epsilon"+')'+chr(92)+"le"+' N('+chr(92)+"epsilon"+')').scale(0.68)
