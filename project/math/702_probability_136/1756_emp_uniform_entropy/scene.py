...
class EmpUniformEntropy(PacedScene):
    """#1756 経験一様エントロピー（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("経験一様エントロピー")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("経験一様エントロピー", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("データ対数", font_size=24).move_to(self.note)
