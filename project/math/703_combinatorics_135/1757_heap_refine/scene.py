...
class HeapRefine(PacedScene):
    """#1757 ヒープ細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ヒープ細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ヒープ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("部分順序", font_size=24).move_to(self.note)
