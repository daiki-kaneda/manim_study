...
class LogQuenchPair(PacedScene):
    """#1759 ログクエンチ対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログクエンチ対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログクエンチ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("食い違い急減", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('a(E)'+chr(92)+"searrow").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('a(E)'+chr(92)+"searrow").scale(0.68)
