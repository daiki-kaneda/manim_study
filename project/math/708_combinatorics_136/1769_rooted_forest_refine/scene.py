...
class RootedForestRefine(PacedScene):
    """#1769 根つき森細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("根つき森細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("根つき森", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("成分", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('RF(n,k)').scale(0.68)
