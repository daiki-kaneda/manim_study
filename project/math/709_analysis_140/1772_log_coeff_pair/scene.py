...
class LogCoeffPair(PacedScene):
    """#1772 ログ係数対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ係数対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ係数", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("境界係数", font_size=24).move_to(self.note)
