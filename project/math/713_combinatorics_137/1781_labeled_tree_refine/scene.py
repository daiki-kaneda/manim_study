...
class LabeledTreeRefine(PacedScene):
    """#1781 ラベル木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ラベル木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def show_formula(self):
        formula = MathTex('L(n,k)').scale(0.68)
