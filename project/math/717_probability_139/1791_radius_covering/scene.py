...
class RadiusCovering(PacedScene):
    """#1791 半径被覆数（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("半径被覆数")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("半径被覆数", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("球被覆", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N(r,'+chr(92)+"epsilon"+')').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('N(r,'+chr(92)+"epsilon"+')'+chr(92)+"lesssim"+' (r/'+chr(92)+"epsilon"+')^d').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('N(r,'+chr(92)+"epsilon"+')'+chr(92)+"lesssim"+' (r/'+chr(92)+"epsilon"+')^d').scale(0.68)
