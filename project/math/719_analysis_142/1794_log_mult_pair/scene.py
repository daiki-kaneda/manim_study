...
class LogMultPair(PacedScene):
    """#1794 ログ多重度対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ多重度対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ多重度", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("特異多重度", font_size=24).move_to(self.note)
