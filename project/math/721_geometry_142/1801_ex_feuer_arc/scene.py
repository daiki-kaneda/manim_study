...
class ExFeuerArc(PacedScene):
    """#1801 傍心フォイエル弧比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心フォイエル弧比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心フォイエル弧", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ell"+'_a/r_a').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ell"+'_a/r_a').scale(0.68)
