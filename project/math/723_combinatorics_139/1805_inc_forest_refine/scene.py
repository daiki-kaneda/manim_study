...
class IncForestRefine(PacedScene):
    """#1805 増加森細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("増加森細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("増加森", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('IF(n,k)').scale(0.68)
