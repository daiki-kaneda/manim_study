...
class EmpRadiusCovering(PacedScene):
    """#1815 経験半径被覆（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("経験半径被覆")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("経験半径被覆", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("データ球被覆", font_size=24).move_to(self.note)
