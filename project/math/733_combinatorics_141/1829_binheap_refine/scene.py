...
class BinHeapRefine(PacedScene):
    """#1829 二分ヒープ細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("二分ヒープ細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("ヒープ順序", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('BH(n,k)').scale(0.68)
