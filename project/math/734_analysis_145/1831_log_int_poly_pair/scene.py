...
class LogIntPolyPair(PacedScene):
    """#1831 ログ交多項式対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ交多項式対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ交多項式", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("交差展開", font_size=24).move_to(self.note)
