...
class InFeuerCenter(PacedScene):
    """#1848 内心フォイエル中心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心フォイエル中心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心フォイエル中心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('IN/r').scale(0.68)
