...
class ExFeuerCenter(PacedScene):
    """#1849 傍心フォイエル中心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("傍心フォイエル中心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("傍心フォイエル中心", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('I_aN/r_a').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('I_aN/r_a').scale(0.68)
