...
class OrderedForestRefine(PacedScene):
    """#1865 順序森細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("順序森細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("順序森", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("平面順序", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('OF(n,k)').scale(0.68)
