...
class OSymFeuerCenter(PacedScene):
    """#1874 外心類似フォイエル中心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心類似フォイエル中心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心類似中心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('ON_s/R').scale(0.68)
