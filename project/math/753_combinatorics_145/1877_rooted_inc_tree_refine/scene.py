...
class RootedIncTreeRefine(PacedScene):
    """#1877 根つき増加木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("根つき増加木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("根と増加", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('RI(n,k)').scale(0.68)
