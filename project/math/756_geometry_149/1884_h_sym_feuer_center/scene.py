...
class HSymFeuerCenter(PacedScene):
    """#1884 垂心類似フォイエル中心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("垂心類似フォイエル中心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("垂心類似中心", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('HN_s/R').scale(0.68)
