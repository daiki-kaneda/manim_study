...
class GSymFeuerCenter(PacedScene):
    """#1885 重心類似フォイエル中心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("重心類似フォイエル中心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("重心類似中心", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("九点円心", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex('GN_s/'+chr(92)+"ell").scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('GN_s/'+chr(92)+"ell").scale(0.68)
