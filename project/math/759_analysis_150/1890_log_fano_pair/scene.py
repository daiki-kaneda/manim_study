...
class LogFanoPair(PacedScene):
    """#1890 ログファノ対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログファノ対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログファノ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("反豊富", font_size=24).move_to(self.note)
