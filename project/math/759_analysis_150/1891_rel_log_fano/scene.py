...
class RelLogFano(PacedScene):
    """#1891 相対ログファノ対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("相対ログファノ対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("相対ログファノ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("相対反豊富", font_size=24).move_to(self.note)
