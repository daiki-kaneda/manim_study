...
class InFeuerRadius(PacedScene):
    """#1896 内心フォイエル半径比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心フォイエル半径比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心フォイエル半径", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('r/R_N').scale(0.68)
