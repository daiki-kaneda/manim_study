...
class OFeuerRadius(PacedScene):
    """#1898 外心フォイエル半径比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心フォイエル半径比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心フォイエル半径", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('R/R_N=2').scale(0.68)
