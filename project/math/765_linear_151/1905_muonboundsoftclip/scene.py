...
class MuonBoundSoftClip(PacedScene):
    """#1905 MuonBoundSoftClip（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("MuonBoundSoftClip")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("Muon境界軟クリップ", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('U^'+chr(92)+"top"+' U=I').scale(0.62)
