...
class TernaryHeapRefine(PacedScene):
    """#1913 三分ヒープ細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("三分ヒープ細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("三分ヒープ順", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('TH(n,k)').scale(0.68)
