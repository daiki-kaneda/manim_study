...
class SampleScaleCovering(PacedScene):
    """#1923 標本スケール被覆（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("標本スケール被覆")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("標本スケール被覆", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N_n(r,'+chr(92)+"epsilon"+')').scale(0.62)
