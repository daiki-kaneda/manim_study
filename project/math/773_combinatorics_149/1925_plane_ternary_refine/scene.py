...
class PlaneTernaryRefine(PacedScene):
    """#1925 平面三分木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("平面三分木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("平面三分木", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('PT(n,k)').scale(0.68)
