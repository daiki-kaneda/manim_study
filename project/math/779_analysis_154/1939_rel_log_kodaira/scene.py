...
class RelLogKodaira(PacedScene):
    """#1939 相対ログ小平対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("相対ログ小平対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("相対ログ小平", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"kappa"+'(X/S,K+D)').scale(0.62)
