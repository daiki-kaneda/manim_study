...
class LogIitakaFiber(PacedScene):
    """#1940 ログ飯高ファイバー対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ飯高ファイバー対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ飯高ファイバー", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("飯高射", font_size=24).move_to(self.note)
