...
class SampleRadiusComp(PacedScene):
    """#1948 標本半径複雑度（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("標本半径複雑度")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("標本半径複雑度", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("有限標本", font_size=24).move_to(self.note)
