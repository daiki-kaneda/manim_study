...
class DecForestRefine(PacedScene):
    """#1949 減少森細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("減少森細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("減少森", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("ラベル減少", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('DF(n,k)').scale(0.68)
