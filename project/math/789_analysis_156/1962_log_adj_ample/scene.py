...
class LogAdjAmple(PacedScene):
    """#1962 ログ随伴豊富対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ随伴豊富対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ随伴豊富", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("随伴豊富", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('K+D>0').scale(0.68)
