...
class InSymNineChord(PacedScene):
    """#1968 内心類似九点弦比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("内心類似九点弦比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("内心類似九点弦", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ell"+'_{9,s}/r').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ell"+'_{9,s}/r').scale(0.68)
