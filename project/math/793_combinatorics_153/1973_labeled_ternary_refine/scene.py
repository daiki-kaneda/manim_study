...
class LabeledTernaryRefine(PacedScene):
    """#1973 ラベル三分木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ラベル三分木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ラベル三分木", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("三分岐ラベル", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('LT(n,k)').scale(0.68)
