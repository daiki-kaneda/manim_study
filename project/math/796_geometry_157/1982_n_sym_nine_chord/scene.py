...
class NSymNineChord(PacedScene):
    """#1982 九点類似弦比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点類似弦比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点類似弦", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"ell"+'_{9,s}/R_N').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"ell"+'_{9,s}/R_N').scale(0.68)
