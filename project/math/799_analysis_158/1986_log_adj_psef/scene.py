...
class LogAdjPsef(PacedScene):
    """#1986 ログ随伴擬有効対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ随伴擬有効対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ随伴擬有効", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"overline"+'{Eff}').scale(0.62)
