...
class CayleyTernaryRefine(PacedScene):
    """#2009 ケイリー三分木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ケイリー三分木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def mid(self):
        cap = self.ja_text("三分岐公式", font_size=24).move_to(self.note)
    ...
    def show_formula(self):
        formula = MathTex('CT(n,k)').scale(0.68)
