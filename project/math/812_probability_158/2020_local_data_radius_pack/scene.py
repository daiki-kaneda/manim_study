...
class LocalDataRadiusPack(PacedScene):
    """#2020 局所データ半径パッキング（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("局所データ半径パッキング")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("局所データ半径パッキング", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("データ球", font_size=24).move_to(self.note)
