...
class LabeledIncTree(PacedScene):
    """#2033 ラベル増加木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ラベル増加木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ラベル増加木", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('LI(n,k)').scale(0.68)
