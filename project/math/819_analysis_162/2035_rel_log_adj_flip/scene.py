...
class RelLogAdjFlip(PacedScene):
    """#2035 相対ログ随伴フリップ対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("相対ログ随伴フリップ対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("相対ログ随伴フリップ", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("相対小収縮", font_size=24).move_to(self.note)
