...
class TernaryIncTree(PacedScene):
    """#2045 三分増加木細分（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("三分増加木細分")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("三分増加木", font_size=24)
    ...
    def show_formula(self):
        formula = MathTex('TI(n,k)').scale(0.68)
