...
class UnifLocalScaleCov(PacedScene):
    """#2067 一様局所スケール被覆（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("一様局所スケール被覆")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("一様局所スケール被覆", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex('N_{n,u}(B,r,'+chr(92)+"epsilon"+')').scale(0.62)
