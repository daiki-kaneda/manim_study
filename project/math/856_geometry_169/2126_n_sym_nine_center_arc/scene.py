...
class NSymNineCenterArc(PacedScene):
    """#2126 九点類似中心弧比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("九点類似中心弧比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("九点類似中心弧", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex("NN'/"+chr(92)+"widehat"+'{'+chr(92)+"ell"+'}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex("NN'/"+chr(92)+"widehat"+'{'+chr(92)+"ell"+'}').scale(0.68)
