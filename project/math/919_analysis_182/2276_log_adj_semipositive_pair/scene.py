...
class LogAdjSemipositivePair(PacedScene):
    """#2276 ログ随伴準正値対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ随伴準正値対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ随伴準正値", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("準正値", font_size=24).move_to(self.note)
