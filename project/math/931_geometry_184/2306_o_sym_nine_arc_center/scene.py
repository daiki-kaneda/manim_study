...
class OSymNineArcCenter(PacedScene):
    """#2306 外心類似九点弧心比（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("外心類似九点弧心比")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("外心類似九点弧心", font_size=24)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq2 = MathTex(chr(92)+"widehat"+'{'+chr(92)+"ell"+'}/ON').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex(chr(92)+"widehat"+'{'+chr(92)+"ell"+'}/ON').scale(0.68)
