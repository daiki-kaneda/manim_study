...
class LogAdjSeminumeric(PacedScene):
    """#2322 ログ随伴準数値対（約45秒・導出つき）"""

    def construct(self):
        self.show_heading("ログ随伴準数値対")
        self.draw()
        self.mid()
        self.derive()
        self.show_formula()
    ...
    def draw(self):
        ...
        note = self.ja_text("ログ随伴準数値", font_size=24)
    ...
    def mid(self):
        cap = self.ja_text("準数値", font_size=24).move_to(self.note)
    ...
    def derive(self):
        ...
        self.read(0.2)
        eq = MathTex(chr(92)+"kappa"+'_{'+chr(92)+"mathrm"+'{semi}}'+chr(92)+"ge"+' 0').scale(0.62)
        ...
        self.read(0.2)
        eq2 = MathTex('(X,D)'+chr(92)+" "+chr(92)+"mathrm"+'{seminumeric}').scale(0.62)
        eq2.move_to(eq)
    ...
    def show_formula(self):
        formula = MathTex('(X,D)'+chr(92)+" "+chr(92)+"mathrm"+'{seminumeric}').scale(0.68)
